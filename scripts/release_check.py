...
def main():
    ...
    if full:
        run([sys.executable,"-m","pytest","tests/test_v17_investigation_integrity.py","tests/test_v17_signed_checkpoints.py","tests/test_v17_offline_case_verification.py","tests/test_v17_verification_assurance.py","-q"],timeout=240); results["v17_integrity_regression"]={"status":"PASS","tests":44}
