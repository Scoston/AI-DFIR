#!/usr/bin/env python3
"""Project retained Azure Activity Logs or compare a preserved projection."""
...
from v17_azure_activity import INPUT_FORMATS, MAX_OUTPUT_BYTES, compare_replay, normalize, read_document
from v17_integrity import canonical_json_bytes, sha256_bytes


def main() -> int:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--input", required=True, help="Retained UTF-8 JSON Activity Log export")
    ...
    try:
        ...
        if args.out is not None:
            ...
            report = {"status": "NORMALIZED", "source_sha256": result["source_sha256"],
                      "output_sha256": sha256_bytes(encoded), "event_count": result["event_count"],
        ...
        print(json.dumps({"status": "FAIL", "error": "invalid, unavailable, excessive, or conflicting activity input/output",
