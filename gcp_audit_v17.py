#!/usr/bin/env python3
"""Project retained Google Cloud Audit Logs or compare a preserved projection."""
...
from v17_gcp_audit import INPUT_FORMATS, MAX_OUTPUT_BYTES, compare_replay, normalize, read_document
from v17_integrity import canonical_json_bytes, sha256_bytes


def main() -> int:
    parser = argparse.ArgumentParser(description=__doc__)
    parser.add_argument("--input", required=True, help="Retained UTF-8 JSON audit export")
    ...
    try:
        ...
        if args.out is not None:
            ...
            report = {"status": "NORMALIZED", "source_sha256": result["source_sha256"],
                      "output_sha256": sha256_bytes(encoded), "entry_count": result["entry_count"],
        ...
        print(json.dumps({"status": "FAIL", "error": "invalid, unavailable, excessive, or conflicting audit input/output",
